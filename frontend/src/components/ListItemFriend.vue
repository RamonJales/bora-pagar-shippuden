...
<template>
  <span
    class="user-container bg-bp_neutral-800 rounded-[10px] h-[100px] text-white flex justify-between items-center"
  >
    ...
    <BadgeTag class="mr-8" type="secondary" size="small">8 minutos atrás</BadgeTag>
  </span>
</template>

      ...
      <div class="grid space-y-4 lg:grid-cols-3 lg:space-x-6 lg:space-y-0">
        <div class="card-profile">
          ...
          <div class="space-y-2">
            ...
            <div class="relative flex items-center">
              <v-icon name="md-person-outlined" scale="1.2" class="absolute left-3 text-bp_neutral-700" />
          ...
          <div class="space-y-2">
            <div class="flex space-x-2">
              ...
              <TooltipInfo>
                Recomendamos fortemente que você insira sua data de nascimento. Esse dado é
                essencial para a geração de relatórios precisos e para fornecer recomendações de
                eventos que possam contar como horas complementares.
              </TooltipInfo>
            </div>
            <div>
              <vue-tailwind-datepicker v-model="dateValue" as-single :formatter="formatter"
                input-classes="bg-bp_neutral-800 border border-bp_neutral-700 rounded py-4 px-4 text-bp_neutral-50 placeholder:text-bp_neutral-700" />
            </div>
          </div>
        </div>
        ...
        <div class="card-profile">
          ...
          <div class="space-y-2">
            ...
            <div>
              <select class="py-4 card-options w-full bg-bp_neutral-800 text-bp_neutral-50" name="course" id="">
          ...
          <div class="space-y-2">
            <div class="flex space-x-2">
              ...
              <TooltipInfo>
                Recomendamos fortemente que você insira seu histórico acadêmico. Esses dados serão
                utilizados para o preenchimento automático de disciplinas cursadas.
              </TooltipInfo>
            </div>
          ...
          <div class="space-y-2">
            <div class="flex space-x-2">
              ...
              <TooltipInfo>
                Recomendamos fortemente que você insira seus índices acadêmicos. Esses dados serão
                utilizados para ajudar a calcular sua probabilidade de entrar em uma turma, com base
                nos índices de outros usuários na plataforma.
              </TooltipInfo>
            </div>
        ...
        <div class="card-profile">
          ...
          <div class="flex items-center space-x-2 mt-4">
            <div class="relative flex items-center">
              ...
              <v-icon v-if="acceptedTerms" name="md-check-outlined" scale="1.2"
